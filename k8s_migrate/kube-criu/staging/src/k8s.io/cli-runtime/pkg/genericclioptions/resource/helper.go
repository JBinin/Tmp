...
func (m *Helper) Dump(namespace string, name string) (runtime.Object, error) {
	return m.DumpResource(namespace, name, nil)
}

func (m *Helper) DumpResource(namespace, name string, options *metav1.DumpOptions) (runtime.Object, error) {
	return m.RESTClient.Delete().
		NamespaceIfScoped(namespace, m.NamespaceScoped).
		Resource(m.Resource).
		Name(name).
