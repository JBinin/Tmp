...
// PodDumpOptions is the query options to a Pod's remote exec call.
// ---
// TODO: This is largely identical to PodAttachOptions above, make sure they stay in sync and see about merging
// and also when we cut V2, we should export a "StreamOptions" or somesuch that contains Stdin, Stdout, Stder and TTY
//+k8s:openapi-gen=true
type PodDumpOptions struct {
	metav1.TypeMeta `json:",inline"`
	...
	// TTY if true indicates that a tty will be allocated for the dump call.
	// Defaults to false.
	// +optional
	TTY bool `json:"tty,omitempty" protobuf:"varint,4,opt,name=tty"`
	...
	// Defaults to "".
	// +optional
	Container string `json:"container,omitempty" protobuf:"bytes,5,opt,name=checkpointid"`
	// CheckpointID
	// Defaults to "".
	// +optional
	CheckpointID string `json:"checkpointid,omitempty" protobuf:"bytes,5,opt,name=checkpointid"`
	//CheckpointDir
	// Defaults to "".
	// +optional
	CheckpointDir string `json:"checkpointdir,omitempty" protobuf:"bytes,6,opt,name=checkpointdir"`
}
