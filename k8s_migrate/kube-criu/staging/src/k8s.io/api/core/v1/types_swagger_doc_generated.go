...
var map_PodDumpOptions = map[string]string{
	"":              "PodDumpOptions is the query options to a Pod's remote dump call.",
	"stdin":         "Redirect the standard input stream of the pod for this call. Defaults to false.",
	"stdout":        "Redirect the standard output stream of the pod for this call. Defaults to true.",
	"stderr":        "Redirect the standard error stream of the pod for this call. Defaults to true.",
	"tty":           "TTY if true indicates that a tty will be allocated for the dump call. Defaults to false.",
	"container":     "Container in which to execute the command. Defaults to only container if there is only one container in the pod.",
	"checkpointid":  "the checkpointid of container checkpointfile.Required",
	"checkpointdie": "the checkpointdir of container checkpointfile.Required",
}

func (PodDumpOptions) SwaggerDoc() map[string]string {
	return map_PodDumpOptions
}
