...
type Runtime interface {
	...
	SyncPod(pod *v1.Pod, apiPodStatus v1.PodStatus, podStatus *PodStatus, pullSecrets []v1.Secret, backOff *flowcontrol.Backoff,ossSecret *v1.Secret) PodSyncResult
	
	CheckpointPod(pod *v1.Pod, podcheckpoint *v1alpha.PodCheckpoint,secret *v1.Secret)
