	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().LimitRanges(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().LimitRanges(namespace).Watch(options)
			},
		},
		&apiscore.LimitRange{},
		resyncPeriod,
...
func (f *limitRangeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.LimitRange{}, f.defaultInformer)
}

func (f *limitRangeInformer) Lister() core.LimitRangeLister {
	return core.NewLimitRangeLister(f.Informer().GetIndexer())
}
