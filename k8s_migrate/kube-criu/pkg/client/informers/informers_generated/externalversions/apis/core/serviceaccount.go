...
type ServiceAccountInformer interface {
	...
	Lister() core.ServiceAccountLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().ServiceAccounts(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().ServiceAccounts(namespace).Watch(options)
			},
		},
		&apiscore.ServiceAccount{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceAccountInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.ServiceAccount{}, f.defaultInformer)
}

func (f *serviceAccountInformer) Lister() core.ServiceAccountLister {
	return core.NewServiceAccountLister(f.Informer().GetIndexer())
}
