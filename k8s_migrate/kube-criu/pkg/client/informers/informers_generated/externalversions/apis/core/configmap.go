	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().ConfigMaps(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().ConfigMaps(namespace).Watch(options)
			},
		},
		&apiscore.ConfigMap{},
		resyncPeriod,
...
func (f *configMapInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.ConfigMap{}, f.defaultInformer)
}

func (f *configMapInformer) Lister() core.ConfigMapLister {
	return core.NewConfigMapLister(f.Informer().GetIndexer())
}
