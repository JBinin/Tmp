	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().Services(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().Services(namespace).Watch(options)
			},
		},
		&apiscore.Service{},
		resyncPeriod,
...
func (f *serviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.Service{}, f.defaultInformer)
}

func (f *serviceInformer) Lister() core.ServiceLister {
	return core.NewServiceLister(f.Informer().GetIndexer())
}
