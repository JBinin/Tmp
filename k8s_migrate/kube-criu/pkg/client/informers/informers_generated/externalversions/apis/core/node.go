	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().Nodes().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().Nodes().Watch(options)
			},
		},
		&apiscore.Node{},
		resyncPeriod,
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.Node{}, f.defaultInformer)
}

func (f *nodeInformer) Lister() core.NodeLister {
	return core.NewNodeLister(f.Informer().GetIndexer())
}
