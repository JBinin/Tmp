	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().Events(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().Events(namespace).Watch(options)
			},
		},
		&apiscore.Event{},
		resyncPeriod,
...
func (f *eventInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.Event{}, f.defaultInformer)
}

func (f *eventInformer) Lister() core.EventLister {
	return core.NewEventLister(f.Informer().GetIndexer())
}
