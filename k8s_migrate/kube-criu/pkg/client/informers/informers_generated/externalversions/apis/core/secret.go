	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisCore().Secrets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisCore().Secrets(namespace).Watch(options)
			},
		},
		&apiscore.Secret{},
		resyncPeriod,
...
func (f *secretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscore.Secret{}, f.defaultInformer)
}

func (f *secretInformer) Lister() core.SecretLister {
	return core.NewSecretLister(f.Informer().GetIndexer())
}
