...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.PodDumpOptions)(nil), (*core.PodDumpOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_PodDumpOptions_To_core_PodDumpOptions(a.(*v1.PodDumpOptions), b.(*core.PodDumpOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.PodDumpOptions)(nil), (*v1.PodDumpOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_PodDumpOptions_To_v1_PodDumpOptions(a.(*core.PodDumpOptions), b.(*v1.PodDumpOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_PodDumpOptions_To_core_PodDumpOptions(in *v1.PodDumpOptions, out *core.PodDumpOptions, s conversion.Scope) error {
	out.Stdin = in.Stdin
	out.Stdout = in.Stdout
	out.Stderr = in.Stderr
	out.TTY = in.TTY
	...
	out.CheckpointDir = in.CheckpointDir
	return nil
}

// Convert_v1_PodDumpOptions_To_core_PodDumpOptions is an autogenerated conversion function.
func Convert_v1_PodDumpOptions_To_core_PodDumpOptions(in *v1.PodDumpOptions, out *core.PodDumpOptions, s conversion.Scope) error {
	return autoConvert_v1_PodDumpOptions_To_core_PodDumpOptions(in, out, s)
}

func autoConvert_core_PodDumpOptions_To_v1_PodDumpOptions(in *core.PodDumpOptions, out *v1.PodDumpOptions, s conversion.Scope) error {
	out.Stdin = in.Stdin
	out.Stdout = in.Stdout
	out.Stderr = in.Stderr
	out.TTY = in.TTY
...
// Convert_core_PodDumpOptions_To_v1_PodDumpOptions is an autogenerated conversion function.
func Convert_core_PodDumpOptions_To_v1_PodDumpOptions(in *core.PodDumpOptions, out *v1.PodDumpOptions, s conversion.Scope) error {
	return autoConvert_core_PodDumpOptions_To_v1_PodDumpOptions(in, out, s)
}
